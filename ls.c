/*************************************************************************
	> File Name: /home/lzj/ls.c
	> Author: 
	> Mail: 
	> Created Time: 2017年07月16日 星期日 14时49分49秒
 ************************************************************************/
...
//错误处理函数，打印出错误所在的行数和信息
void error(const char *err,int line)
{
...
int main(int argc,char **argv)
{
    ...
    int      flag_param=PARAM_NONE;          //参数种类，即是否有-1和-a选项
    struct stat          buf;
